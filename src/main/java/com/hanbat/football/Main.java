...
public class Main {
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            League premier = new League("프리미어 리그", england, MY_DATE.parse("19920220"), LEAGUE_PATH + "pre_lea.png", "Premier League", "https://www.premierleague.com/");
            DatabaseHelper.saveObject(premier);

            League laliga = new League("라리가 리그", england, MY_DATE.parse("19290101"), LEAGUE_PATH + "laliga_lea.png", "Laliga League", null);
            ...
            Team tottenham = new Team("Tottenham Hotspur FC", "Mauricio Pochittino", 4,
                    TEAM_PATH + "tot.png", new Date(), england, stadium, premier, new HashSet<>());
            DatabaseHelper.saveObject(tottenham);
            premier.getTeams().add(tottenham);

            Team realmadrid = new Team("Real Madrid CF", "Zinedine Yazid Zidane", 1,
                    TEAM_PATH + "realmadrid.png", new Date(), england, stadium, laliga, new HashSet<>());
            DatabaseHelper.saveObject(realmadrid);
            laliga.getTeams().add(realmadrid);
